    ...
    <div class="main-content position-relative max-height-vh-100 h-100">
        <div class="container-fluid py-4">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                    <form action="/front-office/booking/store" method="POST" enctype="multipart/form-data" id="AddPost">
                        @csrf
                        <div class="card-header pb-0">
                            <p class="mb-0 d-flex justify-content-start">Front Office <i class="bi bi-chevron-right"></i>{{ $title }}</p>
                            <div class="d-flex justify-content-end">
                                <button class="btn btn-success btn-sm" style="margin-right: 5px" id="hitung">Book</button>
