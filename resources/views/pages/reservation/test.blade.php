...
@section('content')
                        ...
                        <div class="tab-content mt-2">
                            <div class="tab-pane fade show active" id="home">
                                <div class="row">
                                    ...
                                    {{--  ? Bagian Reservation tidak di buat tampil  --}}
                                    {{--  <div class="col-md-6">
                                        <div class="form-group">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="market_code" id="market_code">
                                            ...
                                            {{--  @foreach ($travelAgents as $travelAgents)
                                                @if(old('market_code') == $travelAgents->id)
                                ...
                                <div class="col-md-6">
                                    <div class="form-group" id="arrival_flight_no" hidden>
                                        ...
                                        <input class="form-control " type="number" name="arrival_flight_no" value="{{ old('arrival_flight_no') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group" id="departure_flight_no" hidden>
                                        ...
                                        <input class="form-control " type="number" name="departure_flight_no" value="{{ old('departure_flight_no') }}">
                                    </div>
                                </div>
                                {{--  End Flight NO  --}}
                                {{--  <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control  " type="time" name="arrival" value="12:00" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Departure Time</label>
                                            <input class="form-control " type="time" name="departure" value="14:00" readonly>
                                        </div>
                                    </div>
                                    {{--  ETA & ETD  --}}
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control " type="number" name="etd" value="{{ old('etd') }}">
                                        </div>
                                    </div>
                                    {{--  End ETA & ETD  --}}
                                    <div class="col-md-4">
    ...
    <script>
        document.getElementById('hitung').addEventListener('click', function() {
            ...
            // Menampilkan nilai yang diambil (opsional, untuk debugging)
            console.log('1. Type Room:', typeRoom);
            console.log('2.Status Room:', statusRoom);
            console.log('3.Rate Type:', rateType);
            console.log('4.No. Of Room:', noOfRoom);
            console.log('5.No. Of Person:', noOfPerson);
            console.log('6.Full Name:', fullName);
            console.log('7.Guest Type:', guestType);
            console.log('8.Gender:', gender);
            console.log('9.Occupation:', occupation);
            console.log('10.Email:', email);
            console.log('11.Phone:', phone);
            console.log('12.Address:', address);
            console.log('13.ID Guest:', idGuest);
            console.log('14.Market Code:', marketCode);
            console.log('15.Arrival Flight No:', arrivalFlightNo);
            console.log('16.Departure Flight No:', departureFlightNo);
            console.log('17.Arrival Date:', arrivalDate);
            console.log('18.Departure Date:', departureDate);
            console.log('19.ETA:', eta);
            console.log('20.ETD:', etd);
            console.log('21.Adults:', adults);
            console.log('22.Childs:', childs);
            console.log('23.Babies:', babies);
            console.log('24.Remarks:', remarks);
            console.log('25.Booked By:', bookedBy);
            console.log('26.Telephone No.:', tlpBy);
            console.log('27.Fax No.:', faxBy);
            console.log('28.Taken By:', takenBy);
            console.log('29.Taken Time:', takenTime);
            console.log('30.Confirmation By:', confirmationBy);
            console.log('31.Confirmation Time:', confirmationTime);
            console.log('32.Input By:', inputBy);
            console.log('33.Input Time:', inputTime);
            console.log('34.Checked By:', checkedBy);
            console.log('35Checked Time:', checkedTime);
