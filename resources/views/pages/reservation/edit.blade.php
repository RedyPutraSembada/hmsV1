                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('capacity') is-invalid @enderror" type="number" name="capacity" value="{{ old('capacity', $room->capacity) }}">
                                        @error('capacity')
                                            <p><small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('floor') is-invalid @enderror" type="number" name="floor" value="{{ old('floor', $room->floor) }}">
                                        @error('floor')
                                            <p><small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
