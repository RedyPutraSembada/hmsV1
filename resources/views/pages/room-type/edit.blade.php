...
@section('content')
    <div class="main-content position-relative max-height-vh-100 h-100">
        <div class="container-fluid py-4">
            <div class="row">
                <div class="col-md-12">
                    <form id="edit_room" action="{{ route('room-type.update', $roomType->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" value="{{ old('name', $roomType->name) }}">
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('base_adult') is-invalid @enderror" type="number" name="base_adult" value="{{ old('base_adult', $roomType->base_adult) }}">
                                        @error('base_adult')
                                            <p><small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('base_child') is-invalid @enderror" type="number" name="base_child" value="{{ old('base_child', $roomType->base_child) }}">
                                        @error('base_child')
                                            <p><small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="breakfast_id">
                                            ...
                                            @foreach ($breakfasts as $breakfast)
                                                @if(old('breakfast_id', $roomType->breakfast_id) == $breakfast->id)
