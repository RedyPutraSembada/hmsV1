...
@section('content')
    <div class="main-content position-relative max-height-vh-100 h-100">
        <div class="container-fluid py-4">
            <div class="row">
                <div class="col-md-12">
                    <form id="edit_source_travel" action="{{ route('source-travel-agent.update', $sourceTravelAgent->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('comission') is-invalid @enderror" type="number" name="comission" value="{{ old('comission', $sourceTravelAgent->comission) }}">
                                        @error('comission')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" value="{{ old('name', $sourceTravelAgent->name) }}">
                                        @error('name')
                                            <p><small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="id_travel_agent">
                                            ...
                                            @foreach ($travelAgents as $travelAgent)
                                                @if(old('id_travel_agent', $sourceTravelAgent->id_travel_agent) == $travelAgent->id)
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const form = document.getElementById('edit_source_travel');
