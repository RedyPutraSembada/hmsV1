...
@section('content')
    <div class="main-content position-relative max-height-vh-100 h-100">
        <div class="container-fluid py-4">
            <div class="row">
                <div class="col-md-12">
                    <form id="edit_status_room" action="{{ route('status-room.update', $statusRoom->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" value="{{ old('name', $statusRoom->name) }}">
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('main_status') is-invalid @enderror" type="number" name="main_status" value="{{ old('main_status', $statusRoom->main_status) }}">
                                        @error('main_status')
                                            <p><small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('operation') is-invalid @enderror" type="number" name="operation" value="{{ old('operation', $statusRoom->operation) }}">
                                        @error('operation')
                                            <p><small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const form = document.getElementById('edit_status_room');
