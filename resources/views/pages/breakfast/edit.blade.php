...
@section('content')
    <div class="main-content position-relative max-height-vh-100 h-100">
        <div class="container-fluid py-4">
            <div class="row">
                <div class="col-md-12">
                    <form id="breakfastForm" action="{{ route('breakfast.update', $breakfast->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" value="{{ old('name', $breakfast->name) }}">
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('total_price') is-invalid @enderror" type="number" name="total_price" value="{{ old('total_price', $breakfast->total_price) }}">
                                        @error('total_price')
                                            <p><small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
