...
@section('content')
    <div class="main-content position-relative max-height-vh-100 h-100">
        <div class="container-fluid py-4">
            <div class="row">
                <div class="col-md-12">
                    <form id="guest_form" action="{{ route('guest.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('exp_identity_card') is-invalid @enderror" type="date" name="exp_identity_card" id="exp_identity_card" value="{{ old('exp_identity_card') }}">
                                    </div>
                                </div>
