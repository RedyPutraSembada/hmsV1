            ...
            <div class="card mb-4">
                ...
                <div class="table-responsive p-0">
                    ...
                    <thead>
                        ...
                        <th class="text-center text-uppercase text-secondary text-x font-weight-bolder opacity-7">Code Room</th>
                            ...
                            <td class="align-middle text-center">
                                    ...
                                    <div class="row justify-content-center">
                                        {{--  <div class="button-container">
                                            @if ($transacrionRoom->status_transaction != 2)
                                                <button type="button" class="custom-button-checkout mt-2" id="checkoutButton" onclick="modalCheck({{ $transacrionRoom->id }})">
                                                    Check Out
                                                </button>
                                            @endif
    ...
    function modalCheck(id) {
        ...
        jQuery.ajax({
            ...
            success: function(result) {
                ...
                var hasill = hasil - paid - discount;
                ...
                var total = (masterTotalPaymentTransaction - masterPaymentPaid - hasill);
                ...
                if (masterPaymentPaid != masterTotalPaymentTransaction) {
                    $('#totalPayment').html(`
                        <div class="modal-body">
                            ...
                            <p><strong>Transaction POS Discount Rp:</strong> <span>${number_format(discount, 0, ',', '.')}</span></p>
                            <p><strong>Total Payment Transaction POS Rp:</strong> <span>${number_format(hasill, 0, ',', '.')}</span></p>
                            <p><strong>Total Payment Unpaid Rp:</strong> <span class="text-warning">${number_format(total, 0, ',', '.')}</span></p>
                        </div>
                    `);
