...
@section('content')
    <div class="main-content position-relative max-height-vh-100 h-100">
        <div class="container-fluid py-4">
            <div class="row">
                <div class="col-md-12">
                    <form id="edit_additional_item" action="{{ route('additional-item.update', $additionalItem->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" value="{{ old('name', $additionalItem->name) }}">
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('price') is-invalid @enderror" type="number" name="price" value="{{ old('price', $additionalItem->price) }}">
                                        @error('price')
                                            <p><small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('qty') is-invalid @enderror" type="number" name="qty" value="{{ old('qty', $additionalItem->qty) }}">
                                        @error('qty')
                                            <p><small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('alias') is-invalid @enderror" type="text" name="alias" value="{{ old('alias', $additionalItem->alias) }}">
                                        @error('alias')
                                            <p><small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" aria-label="Default select example" name="type">
                                            ...
                                            @if ($additionalItem->type == "Room")
                                                <option value="Room" selected>Room</option>
                                                <option value="Transaction">Transaction</option>
                                            @elseif ($additionalItem->type == "Transaction")
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" rows="3" name="description">{{ old('description', $additionalItem->description) }}</textarea>
                                        @error('description')
                                            <p><small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
    ...
    <script>
        document.getElementById('edit_additional_item').addEventListener('submit', function(event) {
